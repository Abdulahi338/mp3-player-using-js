...
function updateProgress(e){
    ...
    const curremtMin =Math.floor(current_time/60);
    const curremtSec = Math.floor(current_time%60);
    console.log(curremtMin)
    console.log(curremtSec)
    duration.textContent = `${curremtMin}:${curremtSec}`
    }
